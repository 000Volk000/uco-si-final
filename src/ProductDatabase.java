...
public class ProductDatabase {
        ...
        public static String[][] searchProduct(String text) {
                ...
                String[][] livingBait = ProductDatabase.getLivingBaitData();
                ...
                String[][] products = java.util.stream.Stream.of(hooks, lines, livingBait, fish, stool, rods)
        ...
        public static String[][] getFishHookData() {
                return new String[][] {
                                ...
                                { App.getBundle().getString("destructor"), "12.30",
                                ...
                                { App.getBundle().getString("joaquinCortes"), "15.00",
        ...
        public static String[][] getFishLinesData() {
                return new String[][] {
                                { App.getBundle().getString("dentalFloss"), "1.50",
                                                "src/assets/fishingLine/dentalFloss.png",
                                ...
                                { App.getBundle().getString("regularLine"), "6.50",
                                                "src/assets/fishingLine/regularLine.png",
                                                App.getBundle().getString("regularLineDesc") }
                };
        }

        public static String[][] getLivingBaitData() {
                return new String[][] {
                                { App.getBundle().getString("baityBait"), "2.20", "src/assets/livingBait/baityBait.png",
                                                App.getBundle().getString("baityBaitDesc") },
                                { App.getBundle().getString("boxAndCheese"), "3.40",
                                                "src/assets/livingBait/boxAndCheese.png",
                                                App.getBundle().getString("boxAndCheeseDesc") },
                                { App.getBundle().getString("clickBait"), "1.99", "src/assets/livingBait/clickBait.png",
                                                App.getBundle().getString("clickBaitDesc") },
                                { App.getBundle().getString("dancingShrimps"), "4.75",
                                                "src/assets/livingBait/dancingShrimps.png",
                                                App.getBundle().getString("dancingShrimpsDesc") },
                                { App.getBundle().getString("rivulet"), "2.80", "src/assets/livingBait/rivulet.png",
                                                App.getBundle().getString("rivuletDesc") },
                                { App.getBundle().getString("worms"), "1.50", "src/assets/livingBait/worms.png",
                                                App.getBundle().getString("wormsDesc") }
                };
        }
        ...
        public static String[][] getFishRodsData() {
                return new String[][] {
                                ...
                                { App.getBundle().getString("minecraftRod"), "45.00",
                                                "src/assets/fishingRod/minecraftRod.png",
